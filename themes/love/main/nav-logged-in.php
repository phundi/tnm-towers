                            ...
                            <ul id="user_dropdown" class="dropdown-content">
								...
								<li class="hide header_credits_small_mobi">
									<a href="<?php echo $site_url;?>/credit" data-ajax="/credit" class="waves-effect">
                                         <?php echo "<span style='font-weight: bold;color: #FF6600;'>MK ".(number_format((int)$profile->balance))."  ".__( 'Credit' )." </span>";?>
									</a>
								</li>
								<?php } ?>
								<?php if( $profile->is_pro <> 1 ) { ?>
								...
								<?php if( $profile->is_pro == 1 ) { ?>
									<li class="header_credits_mobi">
										<a href="<?php echo $site_url;?>/pro" data-ajax="/pro" class="waves-effect"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M2 19h20v2H2v-2zM2 5l5 3.5L12 2l5 6.5L22 5v12H2V5zm2 3.841V15h16V8.841l-3.42 2.394L12 5.28l-4.58 5.955L4 8.84z" /></svg> <?php echo __( 'Subscribed' );?></a>
									</li>
									<li class="divider header_credits_mobi" tabindex="-1"></li>
								<?php } ?>
                                ...
                                <?php if( $profile->is_boosted == '1' && $boost_duration <= $config->boost_expire_time ){?>
									<li class="boosted_message_expire" data-message-expire="<a onclick='clickBoostMe()'><svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 493.944 493.944'><path fill='currentColor' d='M367.468,175.996c-3.368-5.469-9.317-8.807-15.734-8.807h-84.958l45.919-143.098  c1.797-5.614,0.816-11.76-2.662-16.521c-3.464-4.748-9.014-7.57-14.9-7.57h-84.446c-8.02,0-15.125,5.18-17.563,12.814  l-68.487,213.465c-1.797,5.613-0.817,11.756,2.663,16.52c3.464,4.748,9.013,7.57,14.899,7.57h14.868h68.183l-22.006,235.037  c-0.352,3.736,2.004,7.185,5.614,8.227c3.593,1.045,7.427-0.608,9.126-3.961L368.19,194.01  C371.093,188.281,370.82,181.467,367.468,175.996z' /></svg> <?php echo __( 'Boost Me' );?></a>">
                                    <a onclick=""><svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 493.944 493.944'><path fill='currentColor' d='M367.468,175.996c-3.368-5.469-9.317-8.807-15.734-8.807h-84.958l45.919-143.098  c1.797-5.614,0.816-11.76-2.662-16.521c-3.464-4.748-9.014-7.57-14.9-7.57h-84.446c-8.02,0-15.125,5.18-17.563,12.814  l-68.487,213.465c-1.797,5.613-0.817,11.756,2.663,16.52c3.464,4.748,9.013,7.57,14.899,7.57h14.868h68.183l-22.006,235.037  c-0.352,3.736,2.004,7.185,5.614,8.227c3.593,1.045,7.427-0.608,9.126-3.961L368.19,194.01  C371.093,188.281,370.82,181.467,367.468,175.996z' /></svg> <?php echo __( 'Boosted' );?></a>
								...
								<?php }else { ?>
                                    <li>
                                        <a onclick="jQuery('#boost_btn').click();"><svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 493.944 493.944'><path fill='currentColor' d='M367.468,175.996c-3.368-5.469-9.317-8.807-15.734-8.807h-84.958l45.919-143.098  c1.797-5.614,0.816-11.76-2.662-16.521c-3.464-4.748-9.014-7.57-14.9-7.57h-84.446c-8.02,0-15.125,5.18-17.563,12.814  l-68.487,213.465c-1.797,5.613-0.817,11.756,2.663,16.52c3.464,4.748,9.013,7.57,14.899,7.57h14.868h68.183l-22.006,235.037  c-0.352,3.736,2.004,7.185,5.614,8.227c3.593,1.045,7.427-0.608,9.126-3.961L368.19,194.01  C371.093,188.281,370.82,181.467,367.468,175.996z' /></svg> <?php echo __( 'Boost Me' );?></a>
                                    </li>				
                                <?php } ?>
                                
                                <li>
                                    <a href="<?php echo $site_url;?>/popularity" data-ajax="/popularity">
                                    <img width="24px;" height="24px;" style="margin-right: 14px;" src="themes/love/assets/img/pop.svg"  > </img>
                                     <?php echo __( 'Increase Popularity' );?></a>
                                </li>
...
<script>
    ...
    function clickBoostMe(){
        jQuery("#boost_btn").click();
    }
</script>
